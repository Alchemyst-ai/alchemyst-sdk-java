...
package com.alchemyst_ai_sdk.api.client.okhttp

import com.alchemyst_ai_sdk.api.client.AlchemystAiClientAsync
import com.alchemyst_ai_sdk.api.client.AlchemystAiClientAsyncImpl
import com.alchemyst_ai_sdk.api.core.ClientOptions
import com.alchemyst_ai_sdk.api.core.Sleeper
import com.alchemyst_ai_sdk.api.core.Timeout
import com.alchemyst_ai_sdk.api.core.http.Headers
import com.alchemyst_ai_sdk.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [AlchemystAiClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AlchemystAiOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AlchemystAiClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): AlchemystAiClientAsync = builder().fromEnv().build()
    }

    /** A builder for [AlchemystAiOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.alchemyst_ai_sdk.api.core.jsonMapper]. The default is usually sufficient
         ...
         *
         * Defaults to the production environment: `https://platform-backend.getalchemystai.com`.
         */
        ...
        /**
         * Returns an immutable instance of [AlchemystAiClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AlchemystAiClientAsync =
            AlchemystAiClientAsyncImpl(
                clientOptions
                    .httpClient(
