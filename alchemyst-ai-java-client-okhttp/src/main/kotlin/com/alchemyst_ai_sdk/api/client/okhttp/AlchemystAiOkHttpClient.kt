...
import com.alchemyst_ai_sdk.api.client.AlchemystAiClientImpl
...
/**
 * A class that allows building an instance of [AlchemystAiClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AlchemystAiOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AlchemystAiClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): AlchemystAiClient = builder().fromEnv().build()
    }

    /** A builder for [AlchemystAiOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AlchemystAiClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AlchemystAiClient =
            AlchemystAiClientImpl(
                clientOptions
                    .httpClient(
