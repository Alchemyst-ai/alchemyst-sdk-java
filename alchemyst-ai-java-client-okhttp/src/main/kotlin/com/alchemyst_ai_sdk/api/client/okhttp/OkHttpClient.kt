...
import com.alchemyst_ai_sdk.api.core.http.HttpRequestBody
import com.alchemyst_ai_sdk.api.core.http.HttpResponse
import com.alchemyst_ai_sdk.api.errors.AlchemystAiIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw AlchemystAiIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("ALCHEMYST_AI_LOG")?.lowercase()) {
