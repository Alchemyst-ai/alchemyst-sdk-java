...
dependencies {
    testImplementation(project(":alchemyst-ai-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../alchemyst-ai-java-core/src/main/resources/META-INF/proguard/alchemyst-ai-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.alchemyst_ai_sdk.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../alchemyst-ai-java-core/src/main/resources/META-INF/proguard/alchemyst-ai-java-core.pro",
