...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.alchemyst_ai_sdk.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.alchemyst_ai_sdk.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.alchemyst_ai_sdk.api.** {
    <init>(...);
