...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.alchemystai.sdk.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.alchemystai.sdk.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.alchemystai.sdk.** {
    <init>(...);
