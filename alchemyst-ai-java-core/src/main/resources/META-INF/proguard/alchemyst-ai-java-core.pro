...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.alchemyst_ai.sdk.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.alchemyst_ai.sdk.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.alchemyst_ai.sdk.** {
    <init>(...);
