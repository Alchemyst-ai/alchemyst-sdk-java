...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContextViewParams].
         *
    ...
    /** A builder for [ContextViewParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contextViewParams: ContextViewParams) = apply {
            body = contextViewParams.body.toBuilder()
            additionalHeaders = contextViewParams.additionalHeaders.toBuilder()
            additionalQueryParams = contextViewParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ContextViewParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContextViewParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ContextViewParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
