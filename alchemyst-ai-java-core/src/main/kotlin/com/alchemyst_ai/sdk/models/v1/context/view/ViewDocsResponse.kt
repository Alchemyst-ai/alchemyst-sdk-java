...
package com.alchemyst_ai.sdk.models.v1.context.view
...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): ViewDocsResponse = ViewDocsResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ViewDocsResponse && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ViewDocsResponse{additionalProperties=$additionalProperties}"
}
