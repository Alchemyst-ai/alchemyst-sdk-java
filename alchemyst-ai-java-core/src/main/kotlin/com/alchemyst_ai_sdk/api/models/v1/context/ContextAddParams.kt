...
import com.alchemyst_ai_sdk.api.core.Enum
...
/**
 * This endpoint accepts context data and sends it to a context processor for further handling. It
 * returns a success or error response depending on the result from the context processor.
 */
class ContextAddParams
private constructor(
     ...
     */
    fun contextType(): Optional<ContextType> = body.contextType()
    ...
    /** A builder for [ContextAddParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contextAddParams: ContextAddParams) = apply {
            body = contextAddParams.body.toBuilder()
            additionalHeaders = contextAddParams.additionalHeaders.toBuilder()
            additionalQueryParams = contextAddParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
         ...
         */
        fun contextType(): Optional<ContextType> = contextType.getOptional("context_type")
        ...
        class Builder internal constructor() {
            ...
            private var contextType: JsonField<ContextType> = JsonMissing.of()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContextAddParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ContextAddParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
