...
import com.alchemyst_ai_sdk.api.client.okhttp.OkHttpClient
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw AlchemystAiRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            AlchemystAiRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
